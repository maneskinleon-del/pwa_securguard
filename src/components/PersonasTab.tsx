...
import { Upload, Download, Trash2, ShieldAlert, BarChart2, Users, Check, LogIn, AlarmClock, ChevronRight, AlertTriangle, RotateCcw, Truck, User, Pencil, X } from 'lucide-react';
...
export function PersonasTab({ logs, activeInside = [], personas, profile, incidents, onOpenImport, onResetDay, onDeleteAll, onImportPersonas, onRestoreDefaults, onEditPersona, onRemovePersona }: PersonasTabProps) {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() => {
                        if (window.confirm(`¿Eliminar a ${persona.name} del directorio?`)) {
                          onRemovePersona(persona.id);
                        }
                      }}
                      className="p-1.5 rounded-md hover:bg-red-900/30 text-slate-500 hover:text-red-400 transition-colors cursor-pointer"
